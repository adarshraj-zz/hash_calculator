...
namespace HashAlgo {
	public partial class HashForm : Form {
		private const string AppName = "Hash Calculator 0.1";
		...
		void BtnAboutClick(object sender, EventArgs e) {
			...
			sb.Append("\t\t\t")
				...
				.Append("-------------------------------------------------------------------------------------------\n")
				.Append("Hash Calculator can be used to create crypto hash of your files and strings.\n")
				.Append("Utility currently supports MD5, SHA1, SHA256, SHA384 and SHA512.\n\n")
				.Append("Crypto comparer utility can be used to check the hash of the files \n")
				.Append("you received and to verify that they are not tampered.\n")
				.Append("-------------------------------------------------------------------------------------------\n")
				.Append(" For more details or bug report contact to: \n")
				.Append("\t Email : adarshraj.dev@gmail.com\n")
				.Append("\t WebSite : https://adarshr.in\n")
				.Append("-------------------------------------------------------------------------------------------\n")
				.Append("This application comes with no warranty or guarantee.\n")
				.Append("The author is not responsible for any issues happened by using this software.")
				.Append("Also I'm not responsible for whatever \n")
				.Append("the end user do with this product. Thats all up to him/her/Others");
